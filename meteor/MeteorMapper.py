...
class Mapper(session):
    ...
    def MapRead(self, aLibraryMappingDir:str, aMapperCmd:str, aMatchesCount:int,      aMismatchesCount:int, aIsMismatchesPercentage:float, aIsLocalMapping:bool, aMappingFileFormat, aCPUCount:int)->bool:
